...
* Added Create Artist Radio playlist (number of tracks is configurable)

* Added Create Song Radio playlist feature (number of tracks is configurable)

* Added command *artist_radio* to create artist radio playlist from current artist

![artist playlist](http://cl.ly/image/3o2B2G1z3T42/Capture%20d%E2%80%99e%CC%81cran%202014-11-23%20a%CC%80%2017.01.08.png)
...
![update](http://cl.ly/image/031E3g2E0n1s/Capture%20d%E2%80%99e%CC%81cran%202014-11-23%20a%CC%80%2017.02.51.png)

* Added command *lyrics* to get lyrics from current track

* New sub-menu for Current Track (hotkey available for quick access)

![Current Track](http://cl.ly/image/2H0Y3B1B0y21/Capture%20d%E2%80%99e%CC%81cran%202014-11-23%20a%CC%80%2017.00.04.png)
...
* Fixed hard-code user id in update library

* Enhancements to play/pause
...
![](https://cldup.com/2PqjaPTvQi.gif)
